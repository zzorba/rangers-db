...
export type rangers_search_deckKeySpecifier = ('awa' | 'base_deck_id' | 'campaign_id' | 'created_at' | 'description' | 'fit' | 'foc' | 'id' | 'liked_by_user' | 'likes' | 'meta' | 'name' | 'next_deck_id' | 'published' | 'rank' | 'side_slots' | 'slots' | 'spi' | 'tags' | 'updated_at' | 'upgrade' | 'user' | 'user_id' | 'version' | rangers_search_deckKeySpecifier)[];
